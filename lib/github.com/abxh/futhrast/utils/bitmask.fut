...
-- module bitmask_16 = bitmask_1 u16 {def select = select_u16}
-- module bitmask_32 = bitmask_1 u32 {def select = select_u32}
...
local
#[inline]
def select_u32 (b: u32) (k: i64) : i64 =
  let lower = u16.u32 b
...
local
#[inline]
def select_u64 (b: u64) (k: i64) : i64 =
  let lower = u32.u64 b
